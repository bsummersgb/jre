...
buffer = Guest.create!(first_name: "Bruce", last_name: "Buffer",
                  ...
                  Tang Soo Do and has fought as a kickboxer.", profile_pic: File.open("db/images/buffer-hs.jpg"), banner_pic: File.open("db/images/buffer-banner.jpg"))
...
snowden = Guest.create!(first_name: "Edward", last_name: "Snowden",
                  ...
                  outlets.", profile_pic: File.open("db/images/snowden-hs.jpg"), banner_pic: File.open("db/images/snowden-banner.jpg"))
...
kemp = Guest.create!(first_name: "Ross", last_name: "Kemp",
                  ...
                  series Ross Kemp on Gangs.", profile_pic: File.open("db/images/kemp-hs.jpg"), banner_pic: File.open("db/images/kemp-banner.jpg"))



links4 = [ { title: "Ross Kemps on Gangs LA", url: "https://www.youtube.com/watch?v=83Kds10NCGk", image: File.open("db/images/kemp-la.jpg") },
...
rogen = Guest.create!(first_name: "Seth", last_name: "Rogen",
                  ...
                  banner_pic: File.open("db/images/rogen-banner.jpg"))



links4 = [ { title: "Rolling Stone", url: "http://www.rollingstone.com/culture/features/seth-rogen-interview-north-korea-controversy-cover-story-20141217", image: File.open("db/images/rogen-rs.png") },
...
chapelle = Guest.create!(first_name: "Dave", last_name: "Chapelle",
                  ...
                  banner_pic: File.open("db/images/chappelle-banner.jpg"))



links5 = [ { title: "For What it's Worth", url: "https://www.youtube.com/watch?v=Fc8WN3q4VKs", image: File.open("db/images/chappelle-fwiw.png") },
...
wilson = Guest.create!(first_name: "Rainn", last_name: "Wilson",
                  ...
                  profile_pic: File.open("db/images/wilson-hs.jpg"), banner_pic: File.open("db/images/wilson-banner.jpg"))



links6 = [ { title: "Wilson hosts SNL", url: "https://www.youtube.com/watch?v=QC0acqbjizI", image: File.open("db/images/wilson-snl.jpg") },
